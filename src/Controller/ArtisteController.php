...
class ArtisteController extends AbstractController
{
    ...
    {
        return $this->render('back/artiste/index.html.twig', [
    ...
    public function new(Request $request, ArtisteRepository $artisteRepository): Response
    {
        ...
        return $this->renderForm('back/artiste/new.html.twig', [
            'artiste' => $artiste,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('back/artiste/show.html.twig', [
            'artiste' => $artiste,
        ]);
    }
    ...
    public function edit(Request $request, Artiste $artiste, ArtisteRepository $artisteRepository): Response
    {
        ...
        return $this->renderForm('back/artiste/edit.html.twig', [
            'artiste' => $artiste,
            'form' => $form,
        ]);
    }
