...
class FilmController extends AbstractController
{
    ...
    {
        return $this->render('back/film/index.html.twig', [
    ...
    public function new(Request $request, FilmRepository $filmRepository): Response
    {
        ...
        return $this->render('back/film/new.html.twig', [
            'film' => $film,
            'form' => $form,
        ]);
    ...
    {
        return $this->render('back/film/show.html.twig', [
            'film' => $film,
        ]);
    }
    ...
    public function edit(Request $request, Film $film, FilmRepository $filmRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            if ($this->isGranted('ROLE_ADMIN')) {
                ...
                $this->addFlash('danger', 'Vous ne pouvez pas modifier les informations');
                return $this->redirectToRoute('app_film_index');
            }
        }

        return $this->render('back/film/edit.html.twig', [
            'film' => $film,
            'form' => $form,
        ]);
    }
